<template>
    <div id="artistContextModal" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <ul id="artistMenu" class="dropdown-menu shadow show position-fixed"
                    ...
                    <li>
                        <button class="dropdown-item" type="button"
                            @click="emit('context-menu-event', 'shareArtist')"><span
...
onMounted(() => {
    modal = new Modal(document.querySelector('#artistContextModal'));
    menu = document.querySelector('#artistMenu');
