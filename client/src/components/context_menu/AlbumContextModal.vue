<template>
    <div id="albumContextModal" class="modal" tabindex="-1">
                ...
                <ul id="albumMenu" class="dropdown-menu shadow show position-fixed"
                    ...
                    <li>
                        <button class="dropdown-item" type="button"
                            @click="emit('context-menu-event', 'playAlbumNext')"><span
                    ...
                    <li>
                        <button class="dropdown-item" type="button"
                            @click="emit('context-menu-event', 'addAlbumToQueue')"><span
...
onMounted(() => {
    modal = new Modal(document.querySelector('#albumContextModal'));
    menu = document.querySelector('#albumMenu');
