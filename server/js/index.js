...
app.get("/api/profile/tracks/:offset/:total", isAuthenticated, db.get_profile_tracks)
app.get("/api/profile/playlists/:offset/:total", isAuthenticated, db.get_profile_playlists)
app.get("/api/profile/albums/:offset/:total", isAuthenticated, db.get_profile_albums)
app.get("/api/profile/artists/:offset/:total", isAuthenticated, db.get_profile_artists)
...
app.get("/api/user/:id/tracks/:offset/:total", isAuthenticated, db.get_user_tracks)
app.get("/api/user/:id/playlists/:offset/:total", isAuthenticated, db.get_user_playlists)
app.get("/api/user/:id/albums/:offset/:total", isAuthenticated, db.get_user_albums)
app.get("/api/user/:id/artists/:offset/:total", isAuthenticated, db.get_user_artists)
